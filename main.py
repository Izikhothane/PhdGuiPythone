...
class MyWindow:
 def __init__(self, win):
  ...
  self.lblid = Label(win, text='IDENTITY NUMBER')
  ...
  self.lblfirst.place(x=90, y=50)
  self.lblsur.place(x=90, y=100)
  self.lblid.place(x=90, y=150)
  self.lbldob.place(x=90, y=200)
  ...
  self.v0.set(1)
  i = IntVar()
  self.r1 = Radiobutton(text="PhDStudent", variable=i, value=1)
  self.r2 = Radiobutton(text="PhDexaminer", variable=i, value=2)
  ...
  self.txtrate= Entry()
  self.txthours = Entry()
  self.lblstdnum.place(x=90, y=330)
  ...
  self.lblhours.place(x=330, y=390)
  ...
  self.b1 = Button(win, text='SHOW REPORT BELOW', command=self.showReport)
